...
!================================================================================================================================!
!> Retrieve the radial element positions
!================================================================================================================================!
FUNCTION get_sgrid_nelems() RESULT(nelems)
  ! MODULES
  ...
  ! CODE ------------------------------------------------------------------------------------------------------------------------!
  nelems = sgrid%nElems
END FUNCTION get_sgrid_nelems

!================================================================================================================================!
!> Retrieve the radial element positions
!================================================================================================================================!
SUBROUTINE get_sgrid_positions(s_pos)
  ! MODULES
  USE MODgvec_MHD3D_vars,     ONLY: sgrid
  ! INPUT/OUTPUT VARIABLES ------------------------------------------------------------------------------------------------------!
  REAL, DIMENSION(:), INTENT(OUT) :: s_pos !! output array for the element positions of size (nElems+1)
  ! LOCAL VARIABLES -------------------------------------------------------------------------------------------------------------!
  ! CODE ------------------------------------------------------------------------------------------------------------------------!
  s_pos = sgrid%sp
END SUBROUTINE get_sgrid_positions
