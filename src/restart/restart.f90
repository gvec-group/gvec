...
USE MODgvec_MHD3D_Vars, ONLY:X1_base,X2_base,LA_base,sgrid,which_hmap, pres_profile, iota_profile, chi_profile, Phi_profile
...
!===================================================================================================================================
  ...
  IF(MPIroot)THEN
    ...
    DO is=1,nBase
      ...
      WRITE(ioUnit,'(*(E23.15,:,","))')s_IP(is),&
                                       Phi_profile%eval_at_rho( s_IP(is)),&
