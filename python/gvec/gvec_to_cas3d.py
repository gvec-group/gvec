...
parser = argparse.ArgumentParser(
    prog="gvec_to_cas3d",
    description="Convert a GVEC equilibrium to be used in CAS3D",
)
...
parser.add_argument(
    ...
    type=int,
    default=4,
    help="sampling factor for the fourier transform and surface reparametrization",
)
parser.add_argument(
...
def gvec_to_cas3d(
    ...
    with tqdm.tqdm(
        ...
        if stellsym:
            ...
            even = [f"{var}_mns" for var in even]
        ...
        ft["s"] = (
            ...
            ft.rho.data**2,
            dict(
                long_name="radial coordinate, proportional to the toroidal magnetic flux",
                symbol="s",
            ),
        )
